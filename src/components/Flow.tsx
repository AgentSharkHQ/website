...
const STEPS: Step[] = [
  {
    ...
    body: 'A new vertical specialist agent needs a permanent identity to interact with the economy. One call. The ID survives framework migrations.',
    detail: [
      { label: 'shark_id', value: 'shark_7a9f' },
      { label: 'capabilities', value: 'case-law-search, contract-analysis' },
      { label: 'endpoint', value: 'legal-agent.example.com' },
    ],
