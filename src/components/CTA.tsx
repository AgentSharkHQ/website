        ...
        <div className="bezel-inner-accent relative overflow-hidden">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 p-8 md:p-12 lg:p-16">
            <div className="lg:col-span-8 flex flex-col justify-center">
              <h2 className="font-display text-[clamp(2.25rem,4vw,3.25rem)] font-bold text-text-primary leading-[1.05] tracking-hero text-balance">
                The agent economy
                <br />
                runs on{' '}
                <span className="relative inline-block">
                  <span className="relative z-10 text-text-primary">AgentShark</span>
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M2 7 Q 50 1, 100 4 T 198 4" stroke="url(#ctagrad)" strokeWidth="2" fill="none" strokeLinecap="round" />
                    <defs>
              ...
              <p className="mt-6 text-text-secondary text-base md:text-lg max-w-lg leading-relaxed text-pretty">
                One MCP server. Eleven layers. Production-grade infrastructure for every agent you ship,
                and every agent you call.
              </p>
            </div>
